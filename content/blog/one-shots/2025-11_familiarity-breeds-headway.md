...
description: You can't get good as long as you don't feel relatively safe practicing.
date: 2025-11-28
...
As long as you haven't managed to kickstart some momentum, timers can come in very handy. They force you to spend a set amount of time on a task, regardless of perceived productivity. Check out the [Pomodoro technique](https://en.wikipedia.org/wiki/Pomodoro_Technique).
...
Remember to start with small steps. Small enough that you can sustain a frequent practice. To quote Ali Abdaal, [lower the bar until you can maintain consistency](https://youtu.be/WrlkSH87u3I). Your first objective should be to feel, "Oh! This is starting to make sense. I think I can do this.", not to become a prodigy on the first try.
